...
import {
  firstFifteenCards,
  firstFifteenCardNames,
  allCards,
} from "../_test_utilities/_cards.utils";
...
describe("Cards", (): void => {
  ...
  describe(".all", (): void => {
    it("should get cards from server and set it to cards array", async (): Promise<
      void
    > => {
  ...
  describe(".initialize", (): void => {
    ...
    it("should return Cards instance with .cards and .cardNames", async (): Promise<
      void
    > => {
      const cards = await Cards.initialize();
  ...
  describe("#getCardByKey", (): void => {
    it("should throw an error if cards have not loaded", async (): Promise<
      void
    > => {
